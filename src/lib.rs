...
//! Lemmy releases. For Lemmy versions 0.19.4 and up, use versions 1.x.x. For Lemmy versions 0.19.3
//! and under, use versions 0.19.5 and up. This is confusing, but should become a non issue as Lemmy
//! accumulates versions and fewer servers use Lemmy versions use 0.19.3 and lower.
...
impl LemmyClient {
  ...
  /// Mutable map of headers that will be included with each request. Use this method if you want to
  /// add headers other than the JWT.
